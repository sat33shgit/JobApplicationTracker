...
const DialogHeader = React.forwardRef<React.ElementRef<'div'>, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
  return (
    <div
...
const DialogFooter = React.forwardRef<React.ElementRef<'div'>, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
  return (
    <div
